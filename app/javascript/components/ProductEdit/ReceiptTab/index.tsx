...
import { ReceiptPreview, useReceiptPreview } from "$app/components/ProductEdit/ReceiptPreview";
...
export const ReceiptTab = () => {
  ...
  const { subject, html } = useReceiptPreview();

  return (
    <Layout
      preview={<ReceiptPreview html={html} />}
