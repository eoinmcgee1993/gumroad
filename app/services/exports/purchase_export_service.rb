...
class Exports::PurchaseExportService
  PURCHASE_FIELDS = [
    ...
    "Affiliate", "Affiliate commission ($)", "Discover?", "Cancellation Date", "Subscription End Date", "Rating", "Review",
  ...
  private
    def purchase_data(purchase)
      ...
      data = {
        ...
        "Cancellation Date" => purchase.subscription&.user_requested_cancellation_at&.to_s,
