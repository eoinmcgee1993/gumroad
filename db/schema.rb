...
ActiveRecord::Schema[7.1].define(version: 2026_12_06_000005) do
  ...
  create_table "purchases", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.string "recommended_by"
    t.datetime "deleted_at", precision: nil
    t.index ["affiliate_id", "purchase_state", "price_cents", "stripe_refunded", "chargeback_date", "flags", "affiliate_credit_cents"], name: "idx_purchases_on_affiliate_earnings_sum"
