    ...
    describe "posts" do
      ...
      describe "membership product show all posts setting" do
        before  do
          ...
          @pre_purchase_product_post_1 = create(:installment, link: @product, name: "Pre Purchase Product Post 1", published_at: 2.months.ago)
          @pre_purchase_product_post_2 = create(:installment, link: @product, name: "Pre Purchase Product Post 2", published_at: 2.weeks.ago)
          @pre_purchase_tier_post = create(:variant_installment, link: @product, name: "Pre Purchase Tier Post", base_variant: @product.default_tier, published_at: 1.month.ago)
          @pre_purchase_other_tier_post = create(:variant_installment, link: @product, name: "Pre Purchase Other Tier Post", base_variant: other_tier, published_at: 1.week.ago)
          @pre_purchase_multi_product_post = create(:seller_installment, seller: @product.user, name: "Pre Purchase Multi Product Post", published_at: 1.day.ago, bought_products: [@product.unique_permalink])
          @pre_purchase_multi_product_variant_post = create(:seller_installment, seller: @product.user, name: "Pre Purchase Multi Product Variant Post", published_at: 1.day.ago, bought_products: [@product.unique_permalink], bought_variants: [@product.default_tier.external_id])

          @post_purchase_post = create(:installment, link: @product, name: "Post Purchase Post", published_at: Time.current)
          @post_purchase_tier_post = create(:installment, link: @product, name: "Post Purchase Tier Post", installment_type: Installment::VARIANT_TYPE, base_variant: @product.default_tier, published_at: Time.current)
          @post_purchase_other_tier_post = create(:installment, link: @product, name: "Post Purchase Other Tier Post", installment_type: Installment::VARIANT_TYPE, base_variant: other_tier, published_at: Time.current)
